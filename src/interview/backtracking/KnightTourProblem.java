 ...
 * knight visits every square only once. If the knight ends on a square that is one knight's
 *  move from the beginning square (so that it could tour the board 
